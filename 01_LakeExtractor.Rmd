...
# Squash it a bit
```{r}
smashedWeekly <- srCor[,dWL := fui.hue(Red, Green, Blue)
                   ][, .(medWl = median(dWL),
                         sdWl = sd(dWL), 
...
smashedMonthly <- srCor[,dWL := fui.hue(Red, Green, Blue)
                   ][, .(medWl = median(dWL),
                         sdWl = sd(dWL), 
                         dswe1 = mean(pCount_dswe1),
                         dswe3 = mean(pCount_dswe3),
...
weekCount <- smashedWeekly[,.N, .(Hylak_id, period)]
monthCount <- smashedMonthly[,.N, .(Hylak_id, period)]
